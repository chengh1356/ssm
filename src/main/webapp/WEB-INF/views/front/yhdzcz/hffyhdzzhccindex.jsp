...
<script language="javascript">
    ...
    function clccqddetail(id,cid){
        ...
        window.open(encodeURI("yhdzzhccwwdetailIndex.action?id="+id+"cname="+cname),"_blank",s);
    }
    function hchindex(){
        ...
        $.ajax({
            type: "post",
            url: "findAllCjffyhdzzhccqd.action?yhdzclztEntity.cid="+cid,
            dataType: "json",
            success: function(data){
                ...
                for (var i = 0;i<mydata.length; i++){
                    ...
                    mydata[i].address+"</td><td>"+mydata[i].type+"</td><td>"+mydata[i].wjyt+"</td>" +
                    "<td>"+mydata[i].mj+"</td><td>"+mydata[i].zdmj+"</td><td>"+mydata[i].time+"</td></tr>"
                }
