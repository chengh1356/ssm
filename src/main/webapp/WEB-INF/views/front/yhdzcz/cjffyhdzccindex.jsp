...
<script language="javascript">
    ...
    function cjchindex(){
        ...
        $.ajax({
            ...
            url: "findAllCjffyhdzcchzb.action?yhdzclztEntity.xzid="+xzid,
            dataType: "json",
 ...
 str += "<tr><td><a href='javascript:openH(\""+mydata[i].cid+"\",\""+mydata[i].cname +"\");'>"+mydata[i].cname+"</a></td><td>"+mydata[i].total+"</td><td>"+
                    mydata[i].ccjzmj+"</td><td>"+mydata[i].cczdmj+"</td></tr>"                }
    ...
    function openH(cid,titlename){
        $('#w_h').window({
            ...
            href:"hffyhdzIndex.action?yhdzclztEntity.cid="+cid+"&yhdzclztEntity.cname="+titlename,
            modal: true
        });
        $('#w_h').window("open");
    }
