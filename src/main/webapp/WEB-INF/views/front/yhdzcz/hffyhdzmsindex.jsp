...
<script language="javascript">
    ...
    function hchindex(){
        ...
        $.ajax({
            type: "post",
            url: "findAllCjffyhdzmsqd.action?tyhdzfmjlEntity.cid="+cid,
            dataType: "json",
            success: function(data){
                ...
                for (var i = 0;i<mydata.length; i++){
                    str += "<tr><td>"+(i+1)+"</td><td><a href='javascript:openH(\""+mydata[i].id+"\",\""+mydata[i].name +"\");'>"+mydata[i].name+"</a></td><td>"+
                    mydata[i].fmaddress+"</td><td>"+mydata[i].jzlx+"</td><td>"+mydata[i].wjyt+"</td>" +
                    "<td>"+mydata[i].fmclmj+"</td><td>"+mydata[i].zdmj+"</td><td>"+mydata[i].fmtime+"</td></tr>"
                }
    ...
    function openH(id,name){
        ...
        var url = "hyhdzshowFmIndex.action?fmid="+id+'&cid='+cid;
