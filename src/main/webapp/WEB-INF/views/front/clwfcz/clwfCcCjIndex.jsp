...
<script language="javascript">
    ...
    //拆除
    function cjchindex(){
        $("#hcctable").html("<tr><th>村名</th><th>处数</th><th>违法建筑面积(平方米)</th><th>违法占地面积(平方米)</th><th>备注</th></tr>");
        $.ajax({
            type: "post",
            url: "/clwfcz/selectClwfCcCj/"+xzid,
            dataType: "json",
            success: function(data){
                ...
                var str = "<tr><th>村名</th><th>处数</th><th>违法建筑面积(平方米)</th><th>违法占地面积(平方米)</th><th>备注</th></tr>";
                for (var i = 0;i<mydata.length; i++){
                    ...
                    mydata[i].summj+"</td><td>"+mydata[i].sumzdmj+"</td><td>"+mydata[i].bz+"</td></tr>"
                }
                str += "<tr><th>汇总</th><th>"+cxCount+"</th><th>"+wfjzmjCount+"</th><th>"+wfzdmjCount+"</th><th></th></tr>";
    ...
    function openH(cid,titlename){
        $('#w_h').window({
            ...
            maximizable:false,
            collapsible:false,
            href:"hclwfIndex.action?cjclwfjzcchzb.cid="+cid+"&cjclwfjzcchzb.cname="+titlename,
            modal: true
        });
        $('#w_h').window("open");
