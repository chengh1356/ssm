...
<script language="javascript">
   ...
   //补办手续
    function cjchindex(){
        $("#hcctable").html("<tr><th>村名</th><th>户数</th><th>违法建筑面积(平方米)</th><th>违法占地面积(平方米)</th><th>收缴总额</th><th>备注</th></tr>");
        $.ajax({
            type: "post",
            url: "/clwfcz/selectClwfYcsyCj/"+xzid,
            dataType: "json",
            success: function(data){
                ...
                var str = "<tr><th>村名</th><th>宗数</th><th>违法建筑面积(平方米)</th><th>违法占地面积(平方米)</th><th>收缴总额(元)</th></tr>";
                for (var i = 0;i<mydata.length; i++){
                    ...
                    str += "<tr><td><a href='javascript:openH(\""+mydata[i].cid+"\",\""+mydata[i].cname +"\");'>"+mydata[i].cname+"</a></td><td>"+mydata[i].zs+"</td><td>"+
    ...
    function openH(cid,titlename){
        $('#w_h').window({
            ...
            maximizable:false,
            collapsible:false,
            href:"hycsyclwfIndex.action?cid="+cid,
            modal: true
        });
        $('#w_h').window("open");
