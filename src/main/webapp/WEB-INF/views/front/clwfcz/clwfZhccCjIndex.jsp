...
<script language="javascript">
   ...
   //补办手续
    function cjchindex(){
        ...
        $.ajax({
            type: "post",
            url: "/clwfcz/selectClwfZhccCj/"+xzid,
            dataType: "json",
            success: function(data){
                ...
                var csCount = 0;
                var str = "<tr><th>村名</th><th>处数</th><th>违法建筑面积(平方米)</th><th>违法占地面积(平方米)</th></tr>";
    ...
    function openH(cid,titlename){
        $('#w_h').window({
            ...
            maximizable:false,
            collapsible:false,
            href:"hzhccclwfIndex.action?cjclwfjzcchzb.cid="+cid+"&cjclwfjzcchzb.cname="+titlename,
            modal: true
        });
        $('#w_h').window("open");
